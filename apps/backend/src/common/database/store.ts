...
export const db = {
  ...
  audit_logs: [
    ...
    {
      id: 'log-103',
      admin_email: 'basaprasaduu@gmail.com',
  ...
  banners: [
    ...
    },
    {
      ...
      targetUrl: '/shop',
      desktopImageUrl: '/real-fit-2.jpg',
      mobileImageUrl: '/real-fit-2.jpg',
    ...
    },
    {
      ...
      targetUrl: '/shop',
      desktopImageUrl: '/real-fit-3.jpg',
      mobileImageUrl: '/real-fit-3.jpg',
    ...
    },
    {
      ...
      targetUrl: '/shop',
      desktopImageUrl: '/real-fit-4.jpg',
      mobileImageUrl: '/real-fit-4.jpg',
    ...
    },
    {
      ...
      targetUrl: '/customize',
      desktopImageUrl: '/real-fit-5.jpg',
      mobileImageUrl: '/real-fit-5.jpg',
  ...
  customizer_config: {
    garments: [
      ...
      },
      {
        ...
        price: 2499,
        compareAtPrice: 3499,
        description: '350 GSM Brushed Fleece · Heavy Pullover',
        isActive: true,
        sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL'],
        activeSizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
        sizeMeasurements: {
