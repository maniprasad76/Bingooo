...
export const FALLBACK_PRODUCTS: FallbackProduct[] = [
  ...
  },
  {
    ...
    description: 'Clean-cut 260 GSM heavyweight combed cotton tee. Zero graphics, zero noise — just premium fabric, a perfect boxy drop shoulder silhouette, and a chest label you can be proud of.',
    basePrice: 799,
    compareAtPrice: 1099,
    customizationEnabled: true,
    category: {
    ...
    variants: [
      ...
      { id: 'v-9-l-blk', sku: 'MHT-BLK-L', size: 'L', color: 'Charcoal Black', colorHex: '#111111', inStock: true, stockQuantity: 28 },
      { id: 'v-9-m-crm', sku: 'MHT-CRM-M', size: 'M', color: 'Vintage Cream', colorHex: '#F7EEDB', inStock: true, stockQuantity: 22 },
      { id: 'v-9-l-wht', sku: 'MHT-WHT-L', size: 'L', color: 'Optic White', colorHex: '#FFFFFF', inStock: true, stockQuantity: 18 },
    ],
    tags: ['minimal', 'heavyweight', 'streetwear', 't-shirts', 'tshirts', 'tees', 'oversized-tees', 'bestseller'],
  },
  {
    id: 'prod-10',
    title: 'Heavyweight Fleece Hoodie',
    slug: 'heavyweight-fleece-hoodie',
    description: '420 GSM ultra-heavyweight loopback fleece. Triple-panel hood, kangaroo pocket with hidden zipper, and ribbed cuffs built for Indian winters and street culture.',
    basePrice: 1499,
    compareAtPrice: 1999,
    customizationEnabled: true,
    category: {
    ...
    fabric_gsm: 420,
    fit_silhouette: 'Relaxed Boxy Fit',
    ...
    variants: [
      ...
      { id: 'v-10-xl-blk', sku: 'HFH-BLK-XL', size: 'XL', color: 'Ink Black', colorHex: '#171717', inStock: true, stockQuantity: 16 },
      { id: 'v-10-m-crm', sku: 'HFH-CRM-M', size: 'M', color: 'Raw Linen', colorHex: '#EDE0CC', inStock: true, stockQuantity: 20 },
      { id: 'v-10-l-crm', sku: 'HFH-CRM-L', size: 'L', color: 'Raw Linen', colorHex: '#EDE0CC', inStock: true, stockQuantity: 15 },
    ],
    tags: ['hoodie', 'fleece', 'winter', 'heavyweight', 'hoodies', 'bestseller'],
  },
  {
    id: 'prod-11',
    title: 'Bold Signature Tee',
    slug: 'bold-signature-tee',
    description: 'Statement-making 280 GSM heavyweight tee featuring an oversized Bingooo chest graphic in high-density screen print. Made for those who wear their culture loud.',
    basePrice: 899,
    compareAtPrice: 1199,
    customizationEnabled: false,
    category: {
    ...
    fabric_gsm: 280,
    fit_silhouette: 'Oversized Boxy Cut',
    ...
    variants: [
      ...
      { id: 'v-11-l-blk', sku: 'BST-BLK-L', size: 'L', color: 'Midnight Black', colorHex: '#111111', inStock: true, stockQuantity: 30 },
      { id: 'v-11-xl-blk', sku: 'BST-BLK-XL', size: 'XL', color: 'Midnight Black', colorHex: '#111111', inStock: true, stockQuantity: 14 },
      { id: 'v-11-m-wht', sku: 'BST-WHT-M', size: 'M', color: 'Optic White', colorHex: '#FFFFFF', inStock: true, stockQuantity: 20 },
    ],
    tags: ['graphic', 'bold', 'streetwear', 't-shirts', 'tshirts', 'graphic-drops', 'bestseller'],
  },
];
