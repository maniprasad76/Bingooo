...
## Communities (669 total, 99 thin omitted)
...
Cohesion: 0.10
Nodes (32): AuthController, ApiBearerAuth, ApiOperation, ApiTags, Body, Controller, Get, HttpCode (+24 more)
...
Cohesion: 0.07
Nodes (34): lazyPage(), AboutPage, ArtworkGuidelinesPage, CartPage, ContactPage, PoliciesPage, PrivacyPolicyPage, ProductPage (+26 more)
...
Cohesion: 0.06
Nodes (44): AuthCallbackPage, CheckoutPage, GooglePayIcon(), PaytmIcon(), PhonePeIcon(), UpiIcon(), Input, InputProps (+36 more)
...
Cohesion: 0.07
Nodes (55): SearchPage, ProductCard(), ProductCardProps, QuickViewModal(), QuickViewModalProps, QuickViewProduct, StickyMobileActionBar(), StickyMobileActionBarProps (+47 more)

### Community 17 - "@nestjs/common"
Cohesion: 0.14
Nodes (13): 5. Security Audit Checklist Before Shipping, Permissions(), PERMISSIONS_KEY, AuthGuard, Injectable, RolesGuard, Injectable, 2. Security & RBAC Guard Pipeline (+5 more)
...
Cohesion: 0.09
Nodes (33): AdminGuard(), NAV_GROUPS, NavGroup, CartDrawer(), RouteFallback(), ScrollProgressBar(), ScrollToTop(), MobileNav() (+25 more)

### Community 22 - "HomePage.tsx"
Cohesion: 0.10
Nodes (23): FaqPage, BRAND_NAME, FaqItemSchema, generateFaqSchema(), generateLocalBusinessSchema(), generateOrganizationSchema(), generateWebSiteSchema(), SITE_URL (+15 more)
...
Cohesion: 0.13
Nodes (17): ConfirmModal(), ConfirmModalProps, RouteErrorBoundary(), BannerItem, BannersPage(), EMPTY_FORM, CategoriesPage(), Category (+9 more)
...
Cohesion: 0.07
Nodes (29): CheckoutController, ApiOperation, ApiTags, Body, Controller, Post, CheckoutModule, Module (+21 more)
...
### Community 190 - "auth.controller.ts"
Cohesion: 0.15
Nodes (14): apps_backend_src_auth_auth_service_changepassworddto, apps_backend_src_auth_auth_service_forgotpassworddto, apps_backend_src_auth_auth_service_logindto, apps_backend_src_auth_auth_service_resetpassworddto, apps_backend_src_auth_auth_service_signupdto, apps_backend_src_auth_auth_service_updateprofiledto, getJwtSecret(), hashPassword() (+6 more)
...
### Community 294 - "Button.tsx"
Cohesion: 0.08
Nodes (29): AddressesPage, OrderDetailPage, OrderSuccessPage, SavedDesignsPage, RouteErrorBoundary(), Badge(), BadgeProps, BadgeSize (+21 more)
...
### Community 353 - "payments.service.ts"
Cohesion: 0.26
Nodes (9): PaymentsModule, Module, CreateOrderDto, RazorpayOrderDto, IsNumber, IsOptional, IsString, VerifyPaymentDto (+1 more)
...
### Community 435 - "AuthCallbackPage"
Cohesion: 1.00
...
### Community 507 - "Gotchas"
Cohesion: 0.67
Nodes (3): Gotchas, Limits, Resources

### Community 508 - "useToast"
Cohesion: 0.16
...
### Community 646 - "KV Patterns & Best Practices"
Cohesion: 0.25
...
Cohesion: 0.06
Nodes (42): AdminModule, Module, AppController, ApiOperation, ApiTags, Controller, Get, AuditModule (+34 more)
...
Cohesion: 0.19
Nodes (13): AdminLayout(), ADMIN_ROLES, adminGoogleLogin(), adminLogin(), adminLogout(), AUTHORIZED_SUPER_ADMIN_EMAIL, AUTHORIZED_SUPER_ADMIN_EMAILS, supabase (+5 more)
...
## Knowledge Gaps
- **4695 isolated node(s):** `supabase`, `name`, `private`, `version`, `type` (+4690 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 5099 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **Why does `@nestjs/common` connect `@nestjs/common` to `payments.service.ts`, `vercel.ts`, `ShippingController`, `app.module.ts`, `saveDb`, `backend/package.json`, `orders.service.ts`, `BannersController`, `audit.module.ts`, `CategoriesController`, `auth.controller.ts`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **What connects `supabase`, `name`, `private` to the rest of the system?**
  _4695 weakly-connected nodes found - possible documentation gaps or missing edges._
